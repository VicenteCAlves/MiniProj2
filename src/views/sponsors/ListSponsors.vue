          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr v-for="sponsor of sponsors" :key="sponsor._id">                
                ...
                <td class="pt-4">{{sponsor.tiposponsor}}</td>
                <td class="pt-4">{{sponsor.percentagem}}</td>
                <td>
                  <router-link
  ...
  methods: {
    ...
    generateTemplate(sponsor) {
      return `
          ...
          <b>Percentagem:</b> ${sponsor.percentagem} <br>
          <b>Tipo de Sponsor:</b> ${sponsor.tiposponsor} <br>
          </p>
        `
    },
    formatDate: d => 
